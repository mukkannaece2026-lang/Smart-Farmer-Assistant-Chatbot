    ...
    <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold mb-4 text-green-400">Smart Farmer AI</h3>
            <p className="text-gray-400 mb-4">
              Empowering farmers with AI-driven insights for better yields and sustainable farming.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Crop Guide</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Farming Guides</a></li>
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Video Tutorials</a></li>
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Market Prices</a></li>
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Weather API</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>support@smartfarmer.ai</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">© 2025 Smart Farmer AI. All rights reserved.</p>
